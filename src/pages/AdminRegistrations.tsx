...
type RegistrationWithDetails = Database['public']['Tables']['registrations']['Row'] & {
  ...
  const updateStatus = useMutation({
    mutationFn: async ({ id, status }: { id: string; status: "approved" | "rejected" }) => {
      ...
      try {
        ...
        console.warn("Session refresh attempt failed, continuing with current session", refreshError);
      }
    ...
    onError: (err: Error) => {
      ...
      const message = err?.message || String(err) || "Unable to update registration status";
      toast.error(message);
    },
  });
